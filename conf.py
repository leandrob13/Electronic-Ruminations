...
BLOG_AUTHOR = "Leandro B"  # (translatable)
BLOG_TITLE = "Electronic Ruminations"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://leandrob13.github.io/Electronic-Ruminations/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://leandrob13.github.io/"
BLOG_EMAIL = "nocontact@nomail.com"
BLOG_DESCRIPTION = "Electronics, programming, music, electronic music programming."  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="https://github.com/leandrob13">{author}</a> -         {license}'
...
RSS_COPYRIGHT = 'Contents © {date} <a href="https://github.com/leandrob13">{author}</a> {license}'
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-VGDFS80SZM"></script>
<script>
